...
class Common(Configuration):
    ...
    ADMINS = (
        ('Vikrant Pogula', 'vikrant.pogula@gmail.com'),
    )
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/rest_test')
...
class Local(Common):
    ...
    ########## DATABASE CONFIGURATION
    # See: https://docs.djangoproject.com/en/dev/ref/settings/#databases
    DATABASES = values.DatabaseURLValue('postgres://rest_test_user:password@localhost/rest_test')
    ########## END DATABASE CONFIGURATION
...
class Production(Common):
    ...
    DEFAULT_FROM_EMAIL = values.Value(
            'rest_test <noreply@example.com>')
    EMAIL_HOST = values.Value('smtp.sendgrid.com')
    EMAIL_HOST_PASSWORD = values.SecretValue(environ_prefix="", environ_name="SENDGRID_PASSWORD")
    EMAIL_HOST_USER = values.SecretValue(environ_prefix="", environ_name="SENDGRID_USERNAME")
    EMAIL_PORT = values.IntegerValue(587, environ_prefix="", environ_name="EMAIL_PORT")
    EMAIL_SUBJECT_PREFIX = values.Value('[rest_test] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
